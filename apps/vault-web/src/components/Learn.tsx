...
const QA: Array<[string, string]> = [
  ...
  ["Can I withdraw whenever?", "Yes. Withdrawals come out of the vault's idle cash, and borrowing is capped at 50% of the pool, so there's always a meaningful amount you can exit against — even mid-session."],
