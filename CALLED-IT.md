...
- [x] **Phase 1.3** `CalledItFloat.sol` + 20 Foundry tests (all pass, 1000-run fuzz clean). **Deployed to Somnia Shannon (chain 50312): `0x10D2Dd3864Eb090Eb89599795c59de228C528DDf`** ("Housepool" / HPOOL). Not audited.
